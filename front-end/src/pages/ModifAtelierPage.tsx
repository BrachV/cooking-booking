...
export const ModifAtelierPage = () => {

	//todo récupérer id depuis url puis faire requête pour récupérer les données de l'atelier
	...
	return (
		<>
			<div className="bg-gray-50 min-h-screen">
				<HeaderComponent />
				<h1 className="m-6 mt-8 flex justify-center font-semibold text-2xl">Modifier un atelier</h1>
				<div className="flex flex-col bg-white rounded-xl p-4 w-80 mx-auto">
					<div className="flex flex-col items-center">
						...
						<div className="flex flex-row justify-center items-center">
							<button className="bg-blue-500 text-white p-2 rounded-lg m-2 w-52 text-center">Modifier</button>
						</div>
					</div>
				</div>
			</div >
